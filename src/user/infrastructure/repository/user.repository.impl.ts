...
export class UserRepositoryImpl implements UserRepository {
  constructor(
    ...
    private readonly userOrmRepository: EntityRepository<UserEntity>,
  ...
  async findById(userId: string): Promise<User | null> {
    const userEntity = await this.userOrmRepository.findOne({ id: userId });
  ...
  async deleteById(userId: string): Promise<void> {
    const userEntity = await this.userOrmRepository.findOne({ id: userId }, { populate: ['auth', 'scraps'] });
